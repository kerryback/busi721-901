...
The six assignments for module 1 are provided below.  For each assignment, submit a Jupyter notebook.  If there are multiple questions in an assignment, copy each question into a Markdown cell and provide your answer in the cell or cells below it.
