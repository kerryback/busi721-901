...
- What one would earn per year on a bond if held to maturity (assuming no default) is called the [bond yield]{style="color:tomato;"}.
...
## Yield and Price <a href="https://bbcx-investments.com/fixed-income/prices-yields"><img src="images/Rice_Owl.jpg" style="width:.8in;" align="right"> </a>
...
- When market [rates rise]{style="color:tomato;"}, a bond [price falls]{style="color:tomato;"} until its yield is commensurate with market rates.
- When market [rates fall]{style="color:tomato;"}, a bond [price rises]{style="color:tomato;"} until its yield is commensurate with market rates.
