...
- The 1/2 is unnecessary but conventional. The number $A$ reflects how much we dislike variance.  
- $A =$ risk aversion. 
...
- For frontier portfolios, the marginal benefit-cost ratio is the same across assets:
  - marginal benefit / marginal cost $= k$
  - marginal benefit = risk premium
  - marginal benefit is the marginal contribution to portfolio risk $C_i^\top w$
  - $(\bar{r}_i-r_f)/C_i^\top w = k$
- The optimal frontier portfolio for risk aversion $A$ is the one for which the marginal benefit-cost ratio equals $A$.
