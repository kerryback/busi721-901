...
- $(a+b)^2 = a^2 + b^2 + 2ab$, so the squared deviation is the sum of [$w_1^2(r_1-\bar{r}_1)^2$]{style="color:green;"},
 [$w_2^2(r_2 - \bar{r}_2)^2$]{style="color:purple;"}, and [$2w_1w_2(r_1-\bar{r}_1)(r_2-\bar{r}_2)$]{style="color:red;"}.
...
- $\rho = $ correlation between $r_1$ and $r_2$
- $\text{cov}(r_1, r_2) = \rho \times \text{stdev}(r_1) \times \text{stdev}(r_2)$
...
## Monthly CVX and AAPL returns since 2016
...
rets = pdr(['cvx', 'aapl'], "yahoo", start=2016)['Adj Close']  
...
print(f"std dev of APPL is {rets.AAPL.std(): .2%}")
