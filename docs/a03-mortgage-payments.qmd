...
- You may need to do 
<br>[pip install numpy-financial]{style="font-family:courier; font-weight:bold"}
- Convention is that payments, including balloon, are negative.
- Principal received is positive.  It is called [pv]{style="font-family:courier; font-weight:bold"}.
- Ballon is called [fv]{style="font-family:courier; font-weight:bold"}.
- Functions are [rate, pmt, pv, fv]{style="font-family:courier; font-weight:bold"}.
