...
2.  Three assets have standard deviations of 20%, 30%, and 40%.  Their expected returns are 10%, 15%, and 12%.  Their correlations are corr12=0.1, corr13=0.3, corr23=0.5.  Compute the mean and standard deviation of a portfolio that is 25% in stock 1, 50% in stock 2, and 25% in stock 3.  Plot the assets and the portfolio in mean -- standard deviation space.
